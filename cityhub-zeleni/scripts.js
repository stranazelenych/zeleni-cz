    ...
    $(document).ready(function(){
        ...
        $(window).load(function(){
			...
			$( window ).on( "resize", function() {
				var $szspan = $( ".home .call-to-action-wrapper .span6" ),
					$img = $szspan.eq(0).find( "img" ),
					szspan_height = $img.height();

				$szspan.height( szspan_height ).find( "a" ).css( "line-height", szspan_height + "px" );
			}).trigger( "resize" );
        });
        ...
        $('.project-images-container').flexslider({
            ...
            start: function(slider){
                ...
                // // calculating smallest image height (? shouldn't be highest ?)
